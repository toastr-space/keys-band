<script lang="ts">
	...
	import { userProfile, webSites } from '$lib/stores/data';
	...
	onMount(async () => {
		let _webSites = $userProfile?.data?.webSites;
							...
							<div class="stat-value">
								<center>
									<span class="countdown font-mono text-6xl">
										<span style="--value: {webSite.history.length.toLocaleString()};" />
									</span>
								</center>
							</div>
						</div>
