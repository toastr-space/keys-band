    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 182, 8, 6046);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code, file, 189, 10, 6257);
    			attr_dev(div, "class", "mockup-code justify-center mt-4 w-11/12 mx-2");
    			add_location(div, file, 188, 8, 6188);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 108, 0, 3567);
    		},
