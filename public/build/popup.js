    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 197, 8, 6653);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code, file, 207, 10, 6950);
    			attr_dev(div, "class", "mockup-code justify-center mt-4 w-11/12 mx-2");
    			add_location(div, file, 206, 8, 6880);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 123, 0, 4025);
    		},
